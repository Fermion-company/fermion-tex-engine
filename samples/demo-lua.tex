...
kerning, and the complete \term{amsmath} machinery. The \engine{} keeps
...
A TikZ picture is just another block --- edit its coordinates and only
this block recompiles:
